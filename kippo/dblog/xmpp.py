...
class DBLogger(dblog.DBLogger):
    ...
    def createSession(self, peerIP, peerPort, hostIP, hostPort):
        ...
        ses = self.create_dom_element_for_event(
    ...
    def handleLoginFailed(self, session, args):
        self.prepare_login_event_for_broadcast(session, args, 'loginfailed')

    def handleLoginSucceeded(self, session, args):
        self.prepare_login_event_for_broadcast(session, args, 'loginsucceeded')

    def handleCommand(self, session, args):
        self.handle_and_report_command(session, 'known', args)

    def handleUnknownCommand(self, session, args):
        self.handle_and_report_command(session, 'unknown', args)

    def create_dom_element_for_event(self, arg0, session, arg2, arg3):
        result = domish.Element((None, arg0))
        result['session'] = session
        result[arg3] = arg2
        return result

    def handle_and_report_command(self, session, arg1, args):
        ses = self.create_dom_element_for_event(
    ...
    def prepare_login_event_for_broadcast(self, session, args, arg2):
        ses = self.create_event_dom_element(
    ...
    def create_event_dom_element(self, arg0, session, args, arg3):
        result = domish.Element((None, arg0))
        result['session'] = session
        result[arg3] = args[arg3]
        return result

    # TODO Rename this here and in `handleLoginFailed`, `handleLoginSucceeded`, `handleInput` and `handleClientVersion`
